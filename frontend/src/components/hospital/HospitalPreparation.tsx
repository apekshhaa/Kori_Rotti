  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="flex flex-col gap-4 bg-gradient-to-br from-slate-800 via-slate-900 to-slate-950 dark:from-[#2c2128] dark:via-[#1a1316] dark:to-[#0f0a0d] p-6 rounded-2xl border border-slate-700 dark:border-[#382a33] shadow-lg">
        ...
        {rerouteSuccess && (
          <div className="flex items-start gap-3 p-3 rounded-lg bg-emerald-950/50 border border-emerald-800/50 animate-fadeIn">
            <span className="material-symbols-outlined text-emerald-400 mt-0.5 flex-shrink-0">
              check_circle
            </span>
            <div className="flex-1">
              <p className="text-sm font-semibold text-emerald-200">Rerouting Initiated</p>
              <p className="text-xs text-emerald-100/80 mt-0.5">{rerouteSuccess}</p>
            </div>
          </div>
        )}

        {maxReroutesReached && !rerouteSuccess && (
          <div className="flex items-start gap-3 p-3 rounded-lg bg-amber-950/50 border border-amber-800/50">
            <span className="material-symbols-outlined text-amber-400 mt-0.5 flex-shrink-0">
              warning
            </span>
            <div className="flex-1">
              <p className="text-sm font-semibold text-amber-200">Max Reroutes Exceeded</p>
          ...
          <div className="bg-white dark:bg-[#1a1316] rounded-2xl p-6 shadow-xl max-w-sm mx-4 border border-slate-200 dark:border-[#382a33] animate-fadeIn">
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                disabled={isRerouting}
                className="flex-1 px-4 py-2.5 rounded-lg bg-orange-600 hover:bg-orange-700 text-white font-semibold transition-all disabled:opacity-60 active:scale-95 flex items-center justify-center gap-2"
              >
                {isRerouting ? (
                  <>
